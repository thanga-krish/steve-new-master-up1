...
public final class ConnectorStatusCountFilter {
    ...
    public static Map<String, Integer> getStatusCountMap(List<ConnectorStatus> lastestList) {
        return getStatusCountMap(lastestList, false); // default behavior
    }

    public static Map<String, Integer> getStatusCountMap(List<ConnectorStatus> lastestList, boolean printZero) {
        List<ConnectorStatus> filteredList = ConnectorStatusFilter.filterAndPreferZero(lastestList);
