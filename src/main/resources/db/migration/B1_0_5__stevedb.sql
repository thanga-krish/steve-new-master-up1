...
DROP TABLE IF EXISTS `user_wallet_tariff`;
CREATE TABLE `user_wallet_tariff` (
`user_wallet_tariff_pk` int(11) NOT NULL AUTO_INCREMENT,
`id_tag` varchar(30),
`wallet_amount` DOUBLE DEFAULT 0,
`tariff_rate` DOUBLE DEFAULT 0,
PRIMARY KEY (`user_wallet_tariff_pk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
